...
<table border="1">	
	...
	<tr>
		<td>질문타입</td><td>${data.inquiry_type}</td>
	</tr>
	<tr>
	...
	<a href="/semiproj/inquiry/faq/update?seq=${data.seq}" role="button">수정</a>
	<a href="/semiproj/inquiry/faq/delete?seq=${data.seq}" role="button">삭제</a>
