                                        ...
                                        <div class="region">
                                            <ul>
                                                <c:forEach var="r" items="${region}">
                                                    <li name="regionValue" class="regionValue"
                                                        data-region_name="${r.region_name}">${r.region_name}</li>
                                                </c:forEach>
                                            </ul>
                                        </div>
                                ...
                                <div class="table_row">
                                    <div class="cell ticket_cell">
                                        <div class="summerized_movie_info">
                                            ...
                                            <div class="s_info">
                                                <img src="" class="s_age_group"> <span class="s_title"></span> <span
                                                    class="s_class_type"></span> <span class="s_screen_datetime">
                                        ...
                                        <div class="ticket_selection">
                                            <div class="adult">
                                                성인:
                                                <button type="button"
                                                    class="btn btn-outline-dark decreaseBtn cntBtn">-</button>
                                                <input id="adultCnt" name="inputCnt" class="inputCnt" type="text"
                                                    value="0" />
                                                <button type="button"
                                                    class="btn btn-outline-dark increaseBtn cntBtn">+</button>
                                            </div>
                                            <div class="youth">
                                                청소년:
                                                <button type="button"
                                                    class="btn btn-outline-dark decreaseBtn cntBtn">-</button>
                                                <input id="youthCnt" name="inputCnt" class="inputCnt" type="text"
                                                    value="0" />
                                                <button type="button"
                                                    class="btn btn-outline-dark increaseBtn cntBtn">+</button>
                                            </div>
                                            <div class="special">
                                                ...
                                                <button type="button"
                                                    class="btn btn-outline-dark decreaseBtn cntBtn">-</button>
                                                <input id="specialCnt" name="inputCnt" class="inputCnt" type="text"
                                                    value="0" />
                                                <button type="button"
                                                    class="btn btn-outline-dark increaseBtn cntBtn">+</button>
                                            </div>
                        ...
                        <script>
                                    ...
                                    .ajax({
                                        ...
                                        success: function (result) {
                                            ...
                                            for (let i = 0; i < result.length; i++) {
                                                ...
                                                tmp += " data-theater_name=" + result[i].theater_name + ">"
                                                    + result[i].theater_name
                                                    + "</li>";
                                            }
                                            tmp += "</ul>"
                                    ...
                                    .ajax({
                                        ...
                                        success: function (result) {
                                            ...
                                            $(result).each(function (i, ele) {
                                                        tmp += "<li name='movieValue' class='movieValue' data-age_group=" + ele.age_group + " data-title='" + ele.title + "' data-runningtime=" + ele.runningtime + " data-movie_id=" + ele.movie_id + " data-poster_img=" + ele.poster_img + ">"
                            ...
                            $("div.movie_cell")
                                .on(
                                    ...
                                    function () {
                                        ...
                                        //CHECK이미지 본인에게만 추가
                                        $(this).children().siblings("img.movieChk")
                                            .remove();
                                        $(this).siblings().children().siblings(
                                            "img.movieChk").remove();
                                        $(this)
                                            .children("span.title")
                                            .after(
                                                "<img class='movieChk' src='/resources/img/booking/check.png'>")
                                        $(this).css("box-shadow",
                                            "0 0 0 2px #000 inset")
                                        getSchedules();
                                    });
                            ...
                            function getSchedules() {
                                ...
                                if (region_name != undefined && theater_name != undefined
                                    && movie_id != undefined
                                    && screen_date != undefined) {

                                    $
                                        .ajax({
                                            type: "POST",
                                            //data: "regionID=" + regionID + "&theater_id=" + theater_id + "&movie_id=" + movie_id + "&date=" + date,
                                            headers: {
                            ...
                            //상영 일정 클릭 이벤트
                            //OrderInfoDto에 선택한 영화에 대한 정보를 저장.
                            $("div.schedule_cell").on("click", ".scheduleValue",function () {

                                        const theaterDto = $(".theaterValue.active")
                                            .data();
                                        theaterDto.region_name = $(
                                            ".regionValue.active").data(
                                                "region_name");
                                        const movieDto = $(".movieValue.active")
                                            .data();
                                        const orderInfoJson = $(this).data();
                                        Object.assign(orderInfoJson, theaterDto,
                                            movieDto);
                                        ...
                                        $(this).addClass("active");
                                        seatList();
                                        $(".booking_table.scheduleTable").css(
                                            "display", "none");
                                        $(".booking_table.seatTable").css(
                                            "display", "");
                            ...
                            $(".seatAlignment").on("click",".seat",function () {
                                        ...
                                        const totalCnt = adultCnt + youthCnt
                                            + specialCnt;
                                        const selectedCnt = $(this).siblings(
                                            ".selected").length;
                                        ...
                                        } else if (selectedCnt < adultCnt
                                            + youthCnt) {
                                            price = getPriceByType(class_type,
                                                '청소년');
                                        } else if (selectedCnt < adultCnt
                                            + youthCnt + specialCnt) {
                            ...
                            $(".increaseBtn").click(
                                function () {
                                    ...
                                    const totalCnt = parseInt($("#adultCnt").val())
                                        + parseInt($("#youthCnt").val())
                                        + parseInt($("#specialCnt").val());
                                    if (totalCnt < 8) {
                                        const inputCnt = $(this).siblings(
                                            "input[name='inputCnt']");
                                        const cnt = parseInt(inputCnt.val());
                            ...
                            function seatList() {
                                const seat_rows = $(".scheduleValue.active").attr(
                                    "data-seat_rows");
                                const seat_columns = $(".scheduleValue.active").attr(
                                    "data-seat_columns");
                            ...
                            function takenSeatList() {
                                const screen_id = $(".scheduleValue.active").attr(
                                    "data-screen_id");
                                const schedule_id = $(".scheduleValue.active").attr(
                                    "data-schedule_id");
                                const movie_id = $(".scheduleValue.active").attr(
                                    "data-movie_id");
