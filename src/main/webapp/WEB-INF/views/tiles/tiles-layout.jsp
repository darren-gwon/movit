...
<body>
								...
								<div class="center-wrap">
									<form action="/success" method="post">
										<div class="text-center">
											...
											<a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=1ae5e64fdf23e2e6840b736262379606&redirect_uri=http://15.164.162.4:8080/kakaologin&response_type=code">
	...
	<script type="text/javascript">
		...
		var naverLogin = new naver.LoginWithNaverId({
			...
			callbackUrl : "http://15.164.162.4:8080/naverlogin",
