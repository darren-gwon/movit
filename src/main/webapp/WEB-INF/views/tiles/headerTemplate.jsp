...
<div class="header">
	...
	<div class="loginBtnDiv">
		...
		<c:if test="${sessionScope.user_id!=null && kakaoN==null && NaverN==null}">
			<a href="/mypage" style="font-weight: bold; font-size: 18px;"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
