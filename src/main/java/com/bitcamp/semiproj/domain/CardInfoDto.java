...
public class CardInfoDto {
	...
	public String toString() {
		return "CardInfoDto [tid=" + tid + ", bin=" + bin + ", card_type=" + card_type + ", card_mid=" + card_mid
				+ ", approved_id=" + approved_id + ", install_month=" + install_month + ", purchase_corp="
				+ purchase_corp + ", purchase_corp_code=" + purchase_corp_code + ", issuer_corp=" + issuer_corp
				+ ", issuer_corp_code=" + issuer_corp_code + ", kakaopay_purchase_corp=" + kakaopay_purchase_corp
				+ ", kakaopay_purchase_corp_code=" + kakaopay_purchase_corp_code + ", kakaopay_issuer_corp="
				+ kakaopay_issuer_corp + ", kakaopay_issuer_corp_code=" + kakaopay_issuer_corp_code
